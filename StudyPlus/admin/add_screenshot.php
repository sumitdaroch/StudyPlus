...
if(isset($_REQUEST['sub']))
{
	...
	if($f==0)
	{
		foreach($allowedExtsimg as $arrimg)
		{
				...
				{
$q="insert into screenshot(screenshot_title,screenshot_uploadcover,screenshot_category,screenshot_uploaded_by,time)values('$a','$b','$d','$user',NOW())";
					if($conn->query($q))
					{
						move_uploaded_file($_FILES['upld']['tmp_name'],"screenshot_cover/".$b);

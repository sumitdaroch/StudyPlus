...
<!--header-->
	...
	error_reporting('ERROR');
	 ...
	 <br><br>
     <a href="view_tutorial_bl.php?z=<?php echo $z;?>" class="btn btn-success">View Tutorial</a></p>
	 </div>
	<div class="col-md-4">
	<p align="center"><img src="images/a4.jpg" class="img-circle"  class="img-responsive" height="200px" width="200px">
	<br><br>
	<a href="view_video_bl.php?z=<?php echo $z;?>" class="btn btn-success">View Video</a></p>
	</div>
	<div class="col-md-4">
	<p align="center"><img src="images/w6.jpg" class="img-circle"  class="img-responsive" height="200px" width="200px">
	<br><br>
	<a href="view_screenshot_bl.php?z=<?php echo $z;?>" class="btn btn-success">View Screenshot</a></p>
	</div>
    </div> 
	<br><br>
	<!--footer-->

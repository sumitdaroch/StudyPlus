				...
				<div class="container">
					<h2 class="tittle">Our Tutorials</h2>
						...
						<!--- Loop Start -->
							...
							error_reporting('ERROR');
		                    $eid=$_GET['z']; $vd=0;
					$q="select * from tutorial where tutorial_category='$eid'";
					$chk=$conn->query($q);
					while($r=$chk->fetch_assoc())
					{
				?>
							<div class="col-md-4 w3agile_Projects_grid" style="margin-top:10px" >
								<div class="w3agile_Projects_image">
									...
									<p>
										...
										<br>
										<a class="btn btn-success btn-xs active" onclick="f1()">
										<?php
										$fd=0;
										...
										<a onclick="f1()" class="btn btn-warning active btn-xs">View Tutorial</a>
									</p>
											</figcaption>
										</figure>
									</a>
